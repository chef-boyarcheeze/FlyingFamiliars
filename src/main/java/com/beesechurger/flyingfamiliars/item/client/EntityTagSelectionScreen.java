...
public class EntityTagSelectionScreen implements IGuiOverlay
{
    public static final EntityTagSelectionScreen INSTANCE = new EntityTagSelectionScreen();
    ...
    {
        if (incomingStack.getItem() instanceof BaseEntityTagItem item)
        {
            stack = incomingStack;

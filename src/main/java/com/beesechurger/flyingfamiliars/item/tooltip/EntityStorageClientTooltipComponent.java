...
public class EntityStorageClientTooltipComponent implements ClientTooltipComponent
{
    ...
    public EntityStorageClientTooltipComponent(EntityStorageTooltipComponent tooltipComponent)
    {

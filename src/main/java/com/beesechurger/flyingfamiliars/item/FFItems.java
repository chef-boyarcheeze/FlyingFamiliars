...
public class FFItems 
{
	...
	public static final RegistryObject<ForgeSpawnEggItem> MAGIC_CARPET_SPAWN_EGG = register("magic_carpet_spawn_egg", () -> new ForgeSpawnEggItem(FFEntityTypes.MAGIC_CARPET, 0xAD0000, 0x0028AD, new Item.Properties().tab(FlyingFamiliars.FF_TAB)));

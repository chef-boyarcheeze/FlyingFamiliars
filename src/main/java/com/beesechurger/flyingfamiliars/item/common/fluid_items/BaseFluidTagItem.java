...
import com.beesechurger.flyingfamiliars.tags.FluidTagItemHelper;
...
public abstract class BaseFluidTagItem extends BaseExtraTagItem
{
...
///////////////////
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand)
    {
        ...
        FluidTagItemHelper.INSTANCE.ensureTagPopulated(stack);

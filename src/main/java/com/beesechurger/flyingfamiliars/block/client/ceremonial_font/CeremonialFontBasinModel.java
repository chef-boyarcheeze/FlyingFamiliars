...
public class CeremonialFontBasinModel extends Model
{
	...
	public CeremonialFontBasinModel(ModelPart root)
	{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition blue = ornaments.addOrReplaceChild("blue", CubeListBuilder.create().texOffs(49, 45).addBox(0.0F, -7.5F, -8.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(48, 30).addBox(-2.0F, -7.5F, -8.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition red = ornaments.addOrReplaceChild("red", CubeListBuilder.create().texOffs(0, 48).addBox(6.25F, -7.0F, 0.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(41, 45).addBox(6.25F, -7.0F, -2.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));
		PartDefinition yellow = ornaments.addOrReplaceChild("yellow", CubeListBuilder.create().texOffs(33, 45).addBox(-2.0F, -0.5F, 6.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(44, 8).addBox(0.0F, -0.5F, 6.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
		PartDefinition green = ornaments.addOrReplaceChild("green", CubeListBuilder.create().texOffs(29, 0).addBox(-0.75F, -0.5F, 0.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(18, 28).addBox(-0.75F, -0.5F, -2.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-7.5F, -7.0F, 0.0F));
	...
	{
		return new ResourceLocation(FlyingFamiliars.MOD_ID, "textures/block/ceremonial_font/ceremonial_font_basin.png");
	}
}
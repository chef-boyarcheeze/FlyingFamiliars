...
public class BrazierRendererNormal implements BlockEntityRenderer<BrazierBlockEntity>
{	
	public BrazierRendererNormal(BlockEntityRendererProvider.Context c)
	{
	}

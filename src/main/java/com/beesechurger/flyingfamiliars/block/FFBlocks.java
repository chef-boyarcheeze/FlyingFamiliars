...
import com.beesechurger.flyingfamiliars.block.common.*;
...
{
	public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, FlyingFamiliars.MOD_ID);
...
/// Block Entities
	...
	{
		return FFItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
	}
}

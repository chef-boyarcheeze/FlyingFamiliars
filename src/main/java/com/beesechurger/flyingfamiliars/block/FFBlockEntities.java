...
import com.beesechurger.flyingfamiliars.block.entity.*;
...
{
	public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, FlyingFamiliars.MOD_ID);
	
	public static final RegistryObject<BlockEntityType<BrazierBE>> BRAZIER_BLOCK_ENTITY = BLOCK_ENTITIES.register("brazier_block_entity", () -> BlockEntityType.Builder.of(BrazierBE::new, FFBlocks.BRAZIER.get()).build(null));
	public static final RegistryObject<BlockEntityType<RunicPedestalBE>> RUNIC_PEDESTAL_BLOCK_ENTITY = BLOCK_ENTITIES.register("runic_pedestal_block_entity", () -> BlockEntityType.Builder.of(RunicPedestalBE::new, FFBlocks.RUNIC_PEDESTAL.get()).build(null));
	public static final RegistryObject<BlockEntityType<ObeliskBE>> OBELISK_BLOCK_ENTITY = BLOCK_ENTITIES.register("obelisk_block_entity", () -> BlockEntityType.Builder.of(ObeliskBE::new, FFBlocks.OBELISK.get()).build(null));
	public static final RegistryObject<BlockEntityType<VitaAlembicBE>> VITA_ALEMBIC_BLOCK_ENTITY = BLOCK_ENTITIES.register("vita_alembic_block_entity", () -> BlockEntityType.Builder.of(VitaAlembicBE::new, FFBlocks.VITA_ALEMBIC.get()).build(null));
	public static final RegistryObject<BlockEntityType<CeremonialFontBE>> CEREMONIAL_FONT_BLOCK_ENTITY = BLOCK_ENTITIES.register("ceremonial_font_block_entity", () -> BlockEntityType.Builder.of(CeremonialFontBE::new, FFBlocks.CEREMONIAL_FONT.get()).build(null));

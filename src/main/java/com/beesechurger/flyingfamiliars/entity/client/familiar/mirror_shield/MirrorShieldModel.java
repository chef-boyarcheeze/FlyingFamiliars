...
{
	@Override
	public ResourceLocation getModelResource(MirrorShieldEntity entity)
	{
		return new ResourceLocation(FlyingFamiliars.MOD_ID, "geo/familiar/mirror_shield.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(MirrorShieldEntity entity)
	{
		return new ResourceLocation(FlyingFamiliars.MOD_ID, "textures/familiar/mirror_shield/mirror_shield.png");
	}

	@Override
	public ResourceLocation getAnimationResource(MirrorShieldEntity entity) {
		return new ResourceLocation(FlyingFamiliars.MOD_ID, "animations/familiar/mirror_shield.animation.json");
	}

	@Override
	public void setCustomAnimations(MirrorShieldEntity entity, long instanceId, AnimationState customPredicate)
	{
	...
	@Override
	public RenderType getRenderType(MirrorShieldEntity entity, ResourceLocation texture)
	{

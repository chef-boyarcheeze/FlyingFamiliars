...
public class CaptureProjectileModel extends GeoModel<CaptureProjectile>
{
	...
	{
		return new ResourceLocation(FlyingFamiliars.MOD_ID, "animations/wand_effect/projectile/capture_projectile.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(CaptureProjectile animatable)
	{
		return new ResourceLocation(FlyingFamiliars.MOD_ID, "geo/wand_effect/projectile/capture_projectile.geo.json");
	}

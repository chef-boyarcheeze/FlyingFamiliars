...
import com.beesechurger.flyingfamiliars.entity.common.WoodStatueEntity;
...
@OnlyIn(Dist.CLIENT)
public class WoodStatueRenderer extends EntityRenderer<WoodStatueEntity>
{
    ...
    public WoodStatueRenderer(EntityRendererProvider.Context renderManager)
    {
        super(renderManager);
    ...
    @Override
    public ResourceLocation getTextureLocation(WoodStatueEntity entity)
    {
        return InventoryMenu.BLOCK_ATLAS;
    }

    protected void preRenderCallback(WoodStatueEntity entity, PoseStack matrixStackIn, float partialTickTime)
    {
    ...
    @Override
    public void render(WoodStatueEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn)
    {

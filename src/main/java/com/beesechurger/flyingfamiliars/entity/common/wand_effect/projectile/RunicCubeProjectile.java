...
public class RunicCubeProjectile extends BaseWandEffectProjectile
{
    ...
    {
        super(FFEntityTypes.RUNIC_CUBE_PROJECTILE.get(), entity, level);
        this.action = action;
    ...
    public RunicCubeProjectile(Level level, double x, double y, double z)
    {
    ...
    private <E extends GeoAnimatable> PlayState bodyController(AnimationState<E> event)
    {
        ...
        if(!isDead())
        {
            controller.setAnimation(RawAnimation.begin()
                    .thenLoop("animation.runic_cube_projectile.idle"));
        ...
        {
            controller.setAnimation(RawAnimation.begin()
                    .thenLoop("animation.runic_cube_projectile.death"));

...
public class FlamethrowerProjectile extends BaseWandEffectProjectile
{
    public FlamethrowerProjectile(EntityType<? extends FlamethrowerProjectile> proj, Level level)
    {
        super(proj, level);
    }

    public FlamethrowerProjectile(Level level, LivingEntity entity)
    {
        super(FFEntityTypes.FLAMETHROWER_PROJECTILE.get(), entity, level);
    }

    public FlamethrowerProjectile(Level level, double x, double y, double z)
    {

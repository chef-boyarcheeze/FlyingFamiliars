...
public class MirrorShieldEntity extends BaseFamiliarEntity
{
    ...
    public MirrorShieldEntity(EntityType<MirrorShieldEntity> entityType, Level level)
    {
    ...
    private <E extends GeoAnimatable> PlayState bodyController(AnimationState<E> event)
    {
        ...
        if(isMoving())
        {
            controller.setAnimation(RawAnimation.begin()
                    .thenLoop("animation.mirror_shield.body_flying"));
        }
        else
        {
            controller.setAnimation(RawAnimation.begin()
                    .thenLoop("animation.mirror_shield.body_idle"));
        }

...
public class DeepJellyfishEntity extends BaseFamiliarEntity
{
    ...
    public DeepJellyfishEntity(EntityType<DeepJellyfishEntity> entityType, Level level)
    {
    ...
    private <E extends GeoAnimatable> PlayState bodyController(AnimationState<E> event)
    {
        ...
        if(isMoving())
        {
            controller.setAnimation(RawAnimation.begin()
                    .thenLoop("animation.deep_jellyfish.body_flying"));
        }
        else
        {
            controller.setAnimation(RawAnimation.begin()
                    .thenLoop("animation.deep_jellyfish.body_idle"));
        }

...
////////////////////
	...
	public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, FlyingFamiliars.MOD_ID);
...
/// Wand effect sounds:
    ...
    public static final RegistryObject<SoundEvent> TECTONIC_SUNDER = registerSoundEvent("tectonic_sunder");
...
/// Sound Types:
	...
	{
		return SOUNDS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(FlyingFamiliars.MOD_ID, name)));
	}

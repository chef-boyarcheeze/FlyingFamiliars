...
public class FFRecipes
{
    ...
    public static final RegistryObject<RecipeSerializer<TectonicSunderRecipe>> TECTONIC_CRUSH_SERIALIZER = RECIPE_SERIALIZER_REG.register(WAND_EFFECT_TECTONIC_SUNDER, () -> TectonicSunderRecipe.Serializer.INSTANCE);
}
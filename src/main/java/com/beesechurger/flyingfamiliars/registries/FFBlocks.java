...
public class FFBlocks
{
	...
	// Normal Blocks
	public static final RegistryObject<Block> RUNIC_BRICKS = registerBlock("runic_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICKS).strength(2.0f).requiresCorrectToolForDrops().sound(SoundType.STONE).instrument(NoteBlockInstrument.HAT))); // Make custom sound
	...
	public static final RegistryObject<Block> INSCRIBED_RUNIC_BRICKS = registerBlock("inscribed_runic_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICKS).strength(2.0f).requiresCorrectToolForDrops().sound(SoundType.STONE).instrument(NoteBlockInstrument.HAT))); // Make custom sound
	...
	public static final RegistryObject<Block> OBELISK = registerBlock("obelisk", () -> new ObeliskBlock(BlockBehaviour.Properties.copy(FFBlocks.RUNIC_BRICKS.get()).strength(2.0f, 4.0f).requiresCorrectToolForDrops().sound(SoundType.STONE))); // same custom sound as lower bricks
